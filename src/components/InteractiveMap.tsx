    ...
    <div className="w-full max-w-sm mx-auto">
      ...
      >
        <iframe
          ...
          {...(navigator.userAgent.includes('Safari') && !navigator.userAgent.includes('Chrome') && !navigator.userAgent.includes('Edg') && !navigator.userAgent.includes('OPR') ? {} : { loading: 'lazy' })}
